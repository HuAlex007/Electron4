...
module.exports = {
  ...
  // ex. 'http://my-site.com'
  appUrl: 'http://localhost:1337/',//SITE_URL
  ...
  jwt: {
    ...
    token_secret: 'VSr7bEzdtTq5nhre75ZLgwNjTmPcKBIN4w0DgJT9ga5ZOrYB2YbIvViNjL8y9mx'
  },
  ...
  session: {
    // Recommended: 63 random alpha-numeric characters for secret
    // Generate using: https://www.grc.com/passwords.htm
    secret: 'OVDeJyirnaRzIkrG4kOIZtcVpvUJabMy8yITJRuA3FphZffW868DtAW52Q1123z',
  ...
  files: {
    ...
    dirname: 'C:\Users\ahu\Desktop\ElectronAppDir',//PATH_FOR_ASSETS
